...
\begin{figure}[hb]
    \centering
    \includegraphics[width=.4\textwidth]{./pic/Meas_Prep_1.PNG}
    \includegraphics[width=.4\textwidth]{./pic/Meas_Prep_2.PNG}
    \includegraphics[width=.4\textwidth]{./pic/Meas_Prep_3.PNG}
